...
export const Navbar = ({ }: Props) => {
  ...
  return (
    <div className="relative w-screen px-5">
      <div
        className={`w-fit fixed top-4 inset-x-0 mx-5 ml-auto md:mx-auto md:mt-3 border rounded-3xl border-white/[0.2] bg-gray-950 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-50 px-2 md:px-10 py-3 md:py-4 space-x-4`}>
